...
public static partial class S
{
    ...
    { 
        ...
        { Home, new("Hogar") },
        { HomeBody, new("Esta es una aplicación de gestión de proyectos donde organizas tareas en una estructura de árbol como un directorio de archivos. Cada tarea ofrece un resumen de las estadísticas vitales de las tareas subyacentes, el tiempo y los costos estimados e incurridos, etc.") },
