...
GRANT SELECT ON Oak.* TO 'Oak'@'%' WITH GRANT OPTION MAX_STATEMENT_TIME 10;
GRANT INSERT ON Oak.* TO 'Oak'@'%' WITH GRANT OPTION MAX_STATEMENT_TIME 10;
GRANT UPDATE ON Oak.* TO 'Oak'@'%' WITH GRANT OPTION MAX_STATEMENT_TIME 10;
GRANT DELETE ON Oak.* TO 'Oak'@'%' WITH GRANT OPTION MAX_STATEMENT_TIME 10;
GRANT EXECUTE ON Oak.* TO 'Oak'@'%' WITH GRANT OPTION MAX_STATEMENT_TIME 10;